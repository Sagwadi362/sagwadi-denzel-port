  ...
  head: () => ({
    meta: [
      ...
      { title: "Sagwadi Denzel Phaweni — Aspiring Data Analyst" },
      {
        name: "description",
        content:
          "Portfolio of Sagwadi Denzel Phaweni, an aspiring data analyst trained through CAPACITI's AI Acceleration Programme.",
      },
      { name: "author", content: "Sagwadi Denzel Phaweni" },
      {
        property: "og:title",
